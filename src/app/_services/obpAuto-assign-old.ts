 ...
 getInspectionDetails():Observable<any>  {
  ...
  // added 21?july/23025
   ...
   UpdateConstructionInspectionTask(data: FormData): Observable<any> {
    ...
    // if (data.ProofImageFile) { // This check will correctly handle both undefined and null
    //   formData.append('ProofImageURL', data.ProofImageFile, data.ProofImageFile.name);
    // } else {
    //   formData.append('ProofImageURL', '');
    // }
