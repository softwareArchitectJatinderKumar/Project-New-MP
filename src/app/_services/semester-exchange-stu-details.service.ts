...
export class SemesterExchangeStuDetailsService {
  ...
  folderUrl =
    'https://files.lpu.in/umsweb/webftp/DIA/SemesterExchangedocuments/';
  ...
  getStudentById(): Observable<any> {
    ...
    return this.http.get<any>(
      `${AUTH_API_LOCAL}api/SemesterExchangeStudent/GetStudentById`,
      httpOptions,
    );
  }
  ...
  GetIdWiseDocuments(aplicationId: number, regId: string): Observable<any> {
    ...
    return this.http.get(
      AUTH_API +
        'api/SemesterExchangeStudent/GetIdWiseDocuments?ApplicationId=' +
        aplicationId +
        '&RegNo=' +
        regId,
      { headers },
  ...
  GetPendigLists(aplicationId: number): Observable<any> {
    ...
    return this.http.get<any>(
      this.baseUrl +
        'api/SemesterExchangeStudent/GetPendingUploadList?ApplicationId=' +
        aplicationId,
      httpOptions,
    );
  }
  ...
  GetStatusCheckListDocuments(aplicationId: number): Observable<any> {
    ...
    return this.http.get<any>(
      this.baseUrl +
        'api/SemesterExchangeStudent/GetStatusCheckListDocuments?ApplicationId=' +
        aplicationId,
      httpOptions,
    );
  }

  GetIdWiseUploadedDocumentsStatus(
    aplicationId: number,
    regId: string,
  ): Observable<any> {
    var authToken = this.storageService.getUser();
    ...
    return this.http.get<any>(
      this.baseUrl +
        'api/SemesterExchangeStudent/GetIdWiseUploadedDocumentsStatus?ApplicationId=' +
        aplicationId +
        '&RegNo=' +
        regId,
      httpOptions,
  ...
  GetCheckListDocuments(): Observable<any> {
    ...
    return this.http.get<any>(
      `${this.baseUrl}api/SemesterExchangeStudent/GetCheckListDocuments`,
      httpOptions,
    );
  }
  ...
  GetAllCheckListDocs(): Observable<any> {
    ...
    // Make the HTTP GET request with the headers
    return this.http.get<any>(
      `${this.baseUrl}api/SemesterExchangeStudent/GetAllCheckListDocs`,
      httpOptions,
    );
  }
  GetCheckListDocs(ApplicationId: any, RegNo: String): Observable<any> {
    ...
    return this.http.get<any>(
      this.baseUrl +
        'api/SemesterExchangeStudent/GetAllUploadedCheckListDocuments?ApplicationId=' +
        ApplicationId +
        '&RegNo=' +
        RegNo,
      httpOptions,
  ...
  GetIdWiseUploadedDocumentList(
    ...
    return this.http.get<any>(
      this.baseUrl +
        'api/SemesterExchangeStudent/GetIdWiseUploadedDocumentList?ApplicationId=' +
        ApplicationId +
        '&docName=' +
        DocName,
      httpOptions,
  ...
  getUniversityDetails(): Observable<any> {
    ...
    return this.http.get<any>(
      `${this.baseUrl}api/SemesterExchangeStudent/GetAllUniversityDetails`,
      httpOptions,
    );
  }
  ...
  addstuEntryforApproval(dataSoft: any): Observable<any> {
    ...
    return this.http.post(
      AUTH_API +
        'api/SemesterExchangeStudent/CreateSemesterExchangeStudentData',
      dataSoft,
      { headers },
    );
  }
  addUniversity(universityData: University): Observable<any> {
    ...
    //httpOptions.headers.set('Authentication', 'Bearer ' + token);
    return this.http.post(
      AUTH_API + 'api/SemesterExchangeStudent/CreateUniversityData',
      universityData,
      { headers },
    );
  }
  ...
  addSECheckListDocuments(dataSoft: FormData): Observable<any> {
    ...
    return this.http.post(
      AUTH_API +
        'api/SemesterExchangeStudent/SemesterExchangeCheckListDocumentInsert',
      dataSoft,
      { headers },
    );
  }
  ...
  UploadInterviewDocuments(dataSoft: FormData): Observable<any> {
    ...
    return this.http.post(
      AUTH_API +
        'api/SemesterExchangeStudent/SemesterExchangeUploadInterviewSchedule',
      dataSoft,
      { headers },
    );
  }
  ...
  UploadCourseMapping(dataSoft: FormData): Observable<any> {
    ...
    return this.http.post(
      AUTH_API +
        'api/SemesterExchangeStudent/SemesterExchangeUploadCourseMapping',
      dataSoft,
      { headers },
    );
  }
  ...
  ChangeStatusCheckListDoc(dataSoft: FormData): Observable<any> {
    ...
    let headers = new HttpHeaders()
      ...
      .set('Authorization', 'Bearer ' + authToken);
    return this.http.post(
      AUTH_API + 'api/SemesterExchangeStudent/ChangeStatusCheckListDoc',
      dataSoft,
      { headers },
    );
  }
  ...
  createUniversityUsingExcelSheet(
    xmlUniversity: xmlUniversity,
  ): Observable<any> {
    var authToken = this.storageService.getUser();
    let headers = new HttpHeaders()
      //  .set('Authorization', 'Bearer ' + authToken)
    ...
    //httpOptions.headers.set('Authentication', 'Bearer ' + token);
    return this.http.post(
      AUTH_API + 'api/SemesterExchangeStudent/UploadExceldata',
      xmlUniversity,
      { headers },
    );
  }
  ...
  deleteUniversityRecord(deleteUniversity: deleteUniversity): Observable<any> {
    ...
    return this.http.post(
      AUTH_API + 'api/SemesterExchangeStudent/DeleteUniversityRecord',
      deleteUniversity,
      { headers },
    );
  }
  ...
  updateUniversity(universityData: UniversityUpdate): Observable<any> {
    ...
    //httpOptions.headers.set('Authentication', 'Bearer ' + token);
    return this.http.post(
      AUTH_API + 'api/SemesterExchangeStudent/UpdateUniversityData',
      universityData,
      { headers },
    );
  }
  ...
  UploadInterviewDocumenTwo(dataSoft: FormData): Observable<any> {
    ...
    return this.http.post(
      AUTH_API +
        'api/SemesterExchangeStudent/SemesterExchangeUploadInterviewSchedule2',
      dataSoft,
      { headers },
    );
  }
  ...
  getStudentDetailsWithMarks(regdno: any): Observable<any> {
    ...
    return this.http.get(
      AUTH_API +
        'api/SemesterExchangeStudent/GetStudentResultWithGrades?regdno=' +
        regdno,
      { headers },
    );
  }
  ...
  getApplicationDetailsBYId(RegId: string): Observable<any> {
    ...
    return this.http.get<any>(
      `${this.baseUrl}api/SemesterExchangeStudent/GetStudentApplicationDetails?RegistrationNo=${RegId}`,
      httpOptions,
    );
  }
  ...
  SemesterExchangeNewRegistrationForm(dataSoft: FormData): Observable<any> {
    ...
    let headers = new HttpHeaders()
      ...
      .set('Authorization', 'Bearer ' + authToken);
    return this.http.post(
      AUTH_API + 'api/SemesterExchangeStudent/SemesterExchangeNewRegistration',
      dataSoft,
      { headers },
    );
  }
  ...
  getStudentDetailsBYId(RegId: string): Observable<any> {
    ...
    //GetStudentApplicationDetails?RegistrationNo=12211079
    return this.http.get<any>(
      `${AUTH_API_LOCAL}api/SemesterExchangeStudent/GetStudentDetailsById?RegistrationNo=${RegId}`,
      httpOptions,
    );
  ...
  updateApplicationDetails(dataSoft: FormData): Observable<any> {
    ...
    return this.http.post(
      AUTH_API +
        'api/SemesterExchangeStudent/UpdateSemesterExchangeStudentDetails',
      dataSoft,
      { headers },
    );
  }
  ...
  getAllApplications(): Observable<any> {
    ...
    return this.http.get<any>(
      `${this.baseUrl}api/SemesterExchangeStudent/AllSemesterExchangeApplication`,
      httpOptions,
    );
  ...
  getAllApplicationsforHOD(): Observable<any> {
    ...
    return this.http.get<any>(
      `${AUTH_API_LOCAL}api/SemesterExchangeStudent/GetSemesterExchangeApplicationForHOD?UserId=${'0'}`,
      httpOptions,
    );
    // return this.http.get<any>(`${this.baseUrl}api/SemesterExchangeStudent/GetSemesterExchangeStudentDetails`, httpOptions);
  }
  SendApproveRequest(dataSoft: FormData): Observable<any> {
    ...
    let headers = new HttpHeaders()
      ...
      .set('Authorization', 'Bearer ' + authToken);
    return this.http.post(
      AUTH_API + 'api/SemesterExchangeStudent/ApproveStudent',
      dataSoft,
      { headers },
    );
  }
  StudentEvalutionAddNew(dataSoft: FormData): Observable<any> {
    ...
    return this.http.post(
      AUTH_API +
        'api/SemesterExchangeStudent/InsertRecordSEInterviewEvaluation',
      dataSoft,
      { headers },
    );
  }
  ...
  SendForwardRequest(dataSoft: FormData): Observable<any> {
    ...
    let headers = new HttpHeaders()
      ...
      .set('Authorization', 'Bearer ' + authToken);
    return this.http.post(
      AUTH_API + 'api/SemesterExchangeStudent/ForwardStudenttoHOD',
      dataSoft,
      { headers },
    );
  }
  ...
  GetStuDetailsWithImage(RegId: string): Observable<any> {
    ...
    //GetStudentApplicationDetails?RegistrationNo=12211079
    return this.http.get<any>(
      `${AUTH_API_LOCAL}api/SemesterExchangeStudent/GetStudentDetailsWithImage?RegNo=${RegId}`,
      httpOptions,
    );
    // return this.http.get<any>(`${this.baseUrl}api/SemesterExchangeStudent/GetStudentDetailsById?RegistrationNo=${RegId}`, httpOptions);
  }
  ...
  getUniversityLists(ProgramCode: any): Observable<any> {
    ...
    return this.http.get<any>(
      `${this.baseUrl}api/SemesterExchangeStudent/GetUniversityListforProgramCode?ProgramCode=${ProgramCode}`,
      httpOptions,
    );
  }
  ...
  FetchAllProgramCodesList(): Observable<any> {
    ...
    return this.http.get<any>(
      `${this.baseUrl}api/SemesterExchangeStudent/GetAllProgramCodesList`,
      httpOptions,
    );
  }
  // added on 9-Aug-25
  ...
  UpdateDocuments(dataSoft: FormData): Observable<any> {
    ...
    let headers = new HttpHeaders()
      ...
      .set('Authorization', 'Bearer ' + authToken);
    return this.http.post(
      AUTH_API + 'api/SemesterExchangeStudent/UpdateSemesterExchangeDocuments',
      dataSoft,
      { headers },
    );
  }
  ...
  UpdateCounsellingRemarks(dataSoft: FormData): Observable<any> {
    ...
    let headers = new HttpHeaders()
      ...
      .set('Authorization', 'Bearer ' + authToken);
    return this.http.post(
      AUTH_API + 'api/SemesterExchangeStudent/UpdateCounsellingRemarks',
      dataSoft,
      { headers },
    );
  }
  ...
  getEvaluationRemarks(RegId: any): Observable<any> {
    ...
    return this.http.get<any>(
      `${this.baseUrl}api/SemesterExchangeStudent/GetInterviewEvaluationRemarks?RegNo=${RegId}`,
      httpOptions,
    );
  }
  ...
  getAllRemarks(): Observable<any> {
    ...
    return this.http.get<any>(
      `${this.baseUrl}api/SemesterExchangeStudent/GetSemesterExchangeAllUserRemarks`,
      httpOptions,
    );
  }
  ...
  getUniversities(): Observable<any> {
    ...
    return this.http.get<any>(
      `${this.baseUrl}api/SemesterExchangeStudent/GetUniversityLists`,
      httpOptions,
    );
  }
  ...
  GetStudentAllPreviousMarks(regdno: any): Observable<any> {
    ...
    return this.http.get(
      AUTH_API_LOCAL +
        'api/SemesterExchangeStudent/GetStudentPreviousMarksDetails?RegistrationNo=' +
        regdno,
      { headers },
    );
  }
  ...
  GetStage2DocumentDetails(aplicationId: number): Observable<any> {
    ...
    return this.http.get<any>(
      this.baseUrl +
        'api/SemesterExchangeStudent/GetStage2DocumentDetails?ApplicationId=' +
        aplicationId,
      httpOptions,
    );
  }
  ...
  GetAllUploadedDocumentDetails(Id: string): Observable<any> {
    ...
    return this.http.get<any>(
      `${AUTH_API_LOCAL}api/SemesterExchangeStudent/GetAllUploadedDocumentDetails?Id=${Id}`,
      httpOptions,
    );
    // return this.http.get<any>(`${this.baseUrl}api/SemesterExchangeStudent/GetSemesterExchangeStudentDetails`, httpOptions);
  }
  ...
  UpdateDocumentStatus(dataSoft: FormData): Observable<any> {
    ...
    return this.http.post(
      AUTH_API +
        'api/SemesterExchangeStudent/SemesterExchangeUpdateDocumentStatus',
      dataSoft,
      { headers },
    );
  }
  ...
  GetApprovedDocumentDetails(Id: string): Observable<any> {
    ...
    return this.http.get<any>(
      `${AUTH_API_LOCAL}api/SemesterExchangeStudent/GetApprovedDocumentDetails?Id=${Id}`,
      httpOptions,
    );
    // return this.http.get<any>(`${this.baseUrl}api/SemesterExchangeStudent/GetSemesterExchangeStudentDetails`, httpOptions);
  }
  ...
  downloadFileWithFolder(fileUrl: string, folderPath: any): Observable<Blob> {
    const payload = {
      fileName: fileUrl,
