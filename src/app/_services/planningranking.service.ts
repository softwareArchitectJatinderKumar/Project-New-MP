...
// const AUTH_API = 'https://localhost:44362/'; //'https://localhost:7125/'; //
// const AUTH_API_LOCAL = 'https://localhost:44362/'; //'https://localhost:7125/'; //
@Injectable({
  providedIn: 'root',
})
export class PlanningrankingService {
  ...
  getwinglist(): Observable<any> {
    ...
    return this.http.get(AUTH_API + 'api/Planning/GetWingListPlanningRanking', {
      headers,
    });
  }
  ...
  getplannerScoreRankingCalculation(data: any): Observable<any> {
    ...
    return this.http.post(
      AUTH_API + 'api/Planning/GetPlannerScoreRankingCalculation',
      data,
      { headers },
    );
  }
  ...
  getCriteriaMasterDetails(): Observable<any> {
    ...
    //httpOptions.headers.set('Authentication', 'Bearer ' + token);
    return this.http.get(AUTH_API + 'api/Planning/GetCriteriaMasterDetails', {
      headers,
    });
  }
  getKeyIndicatorMasterDetails(): Observable<any> {
    ...
    //httpOptions.headers.set('Authentication', 'Bearer ' + token);
    return this.http.get(AUTH_API + 'api/Planning/GetIndicatorMasterDetails', {
      headers,
    });
  }
  ...
  FetchObpMetricDetails(MetricId: any): Observable<any> {
    ...
    return this.http.get<any>(
      AUTH_API + 'api/Planning/GetObpMetricDetails?MetricId=' + MetricId,
      httpOptions,
    );
