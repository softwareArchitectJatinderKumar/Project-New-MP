...
@Component({
  ...
  templateUrl: './Manage-HeadMapping.component.html',
  styleUrls: ['./Manage-HeadMapping.component.scss']
})
export class ManageHeadMappingComponent implements OnInit {
  moudata:any[]=[];
  constructor(
    private fb: FormBuilder,private cdRef: ChangeDetectorRef,private route: ActivatedRoute,private storageService: StorageService,
