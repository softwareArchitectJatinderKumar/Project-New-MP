...
// @Component({
//   selector: 'app-obpestatefinal-verfication',
//   templateUrl: './obpestatefinal-verfication.component.html',
//   styleUrls: ['./obpestatefinal-verfication.component.scss']
// })
// export class OBPEstatefinalVerficationComponent implements OnInit {
...
//         }
//         (<HTMLInputElement>document.getElementById('stMain')).innerHTML = 'OBP Estate <span class="themeClr" >Final Verification</span>';
...
//     this.showTabs = false; // Hide tabs on session change
...
//     this.ObpService.GetEStateDetailsFinalVerification(sessionId, IsApproved).subscribe({
//       next: (data) => {
...
//         // this.FilterArchitecureData(59);
//         this.ArchitecureData =  this.allOBPStaffData.filter(x => x["divisionId"] == 59);
//         this.ConstructionData =  this.allOBPStaffData.filter(x => x["divisionId"] == 28);
//         this.ElectricalData =  this.allOBPStaffData.filter(x => x["divisionId"] == 58);
//         this.ProjectData =  this.allOBPStaffData.filter(x => x["divisionId"] == 148);
...
//     this.ObpService.UpdateOBPConstructionMetricFinalRemarks(formData).subscribe((data: any) => {
...
// // Developer name : jatinder kumar 31309
...
//   ProjectData: any[] = [];
//   ElectricalData: any[] = [];
//   FilterArchitecureData(DivisionId: any) {
//     this.DivisionId = DivisionId;
//     this.ArchitecureData =  this.allOBPStaffData.filter(x => x["divisionId"] == DivisionId);
//   }

//   FilterConstructionData(divisionId: any){
//     this.ConstructionData =  this.allOBPStaffData.filter(x => x["divisionId"] == divisionId);
     
//   }
//   FilterProjectData(divisionId: any){
//     // alert(0);
//     this.ProjectData =  this.allOBPStaffData.filter(x => x["divisionId"] == divisionId);
//     // alert(JSON.stringify(this.ProjectData))
     
//   }
//   FilterElectricalData(divisionId: any){
//     this.ElectricalData =  this.allOBPStaffData.filter(x => x["divisionId"] == divisionId);
