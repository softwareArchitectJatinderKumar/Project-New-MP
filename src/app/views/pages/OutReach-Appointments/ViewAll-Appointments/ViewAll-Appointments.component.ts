...
@Component({
  selector: 'app-ViewAll-Appointments',
  templateUrl: './ViewAll-Appointments.component.html',
  styleUrls: ['./ViewAll-Appointments.component.scss']
})
export class ViewAllAppointmentsComponent implements OnInit {
  ...
  GetAllUploadsDetails(): void {
    // this.mouDocumentsService.GetAllAppointments().subscribe({
    //   next: response => {
    //     if (response.item1.length > 0) {
    ...
    //       console.log('Data' + JSON.stringify(this.filteredMouDocumentDetails))
  ...
  ChangeUpdateSchoolDivision(Id: any, School: any, StartDate: any, EndDate: any, Status: any, SPName: any, SPContact: any,SPEmail: any) {
    const formData = new FormData();
    formData.append('Id', Id);
