...
@Component({
  ...
  templateUrl: './FacultyDashboardNew.html',
  styleUrls: ['./DashboardFaculty.component.css'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class FacultyDashboardNew implements OnInit {
  ...
  selectedRemarksCallerRole:  'faculty' = 'faculty';
