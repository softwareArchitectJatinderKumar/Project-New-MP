...
//     templateUrl: './StudentDashboardwithTabs.components-oldcode.html',
...
//       const controls: any = {};
//       const allKeys = [...this.personalKeys, ...this.universityKeys, ...this.passportKeys, ...this.visaKeys, ...this.englishKeys, ...this.sponsorKeys, ...this.financeKeys, 'applicationId'];
//       allKeys.forEach(key => {
...
//         relativeName: [this.stuApplication?.relativeName || ''], // Add this line
//         relativeRelation: [this.stuApplication?.relativeRelation || ''], // Add this line
//         relativeCountry: [this.stuApplication?.relativeCountry || ''], // Add this line
//       };
...
//         "RelativeName",      "RelativeRelation", "RelativeCountry" // Add these lines
//       ];
...
//     // ---------------- IMAGE / STUDENT DETAILS WITH IMAGE ----------------
