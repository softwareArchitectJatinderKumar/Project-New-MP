export const countries: { name: string }[] = [
  ...
  { name: 'Colombia' }, { name: 'Comoros' }, { name: 'Congo (Brazzaville)' },
  { name: 'Congo (Kinshasa)' }, { name: 'Costa Rica' }, { name: 'Croatia' },
  ...
  { name: 'Estonia' }, { name: 'Eswatini' }, { name: 'Ethiopia' },
  ...
  { name: 'Niger' }, { name: 'Nigeria' }, { name: 'North Korea' },
  { name: 'North Macedonia' }, { name: 'Norway' }, { name: 'Oman' },
  { name: 'Pakistan' }, { name: 'Palau' }, { name: 'Palestine' },
  { name: 'Panama' }, { name: 'Papua New Guinea' }, { name: 'Paraguay' },
  ...
  { name: 'Somalia' }, { name: 'South Africa' }, { name: 'South Korea' },
  { name: 'South Sudan' }, { name: 'Spain' }, { name: 'Sri Lanka' },
  { name: 'Sudan' }, { name: 'Suriname' }, { name: 'Sweden' },
  { name: 'Switzerland' }, { name: 'Syria' }, { name: 'Taiwan' },
  { name: 'Tajikistan' }, { name: 'Tanzania' }, { name: 'Thailand' },
  { name: 'Timor-Leste' }, { name: 'Togo' }, { name: 'Tonga' },
  { name: 'Trinidad and Tobago' }, { name: 'Tunisia' }, { name: 'Turkey' },
  { name: 'Turkmenistan' }, { name: 'Tuvalu' }, { name: 'Uganda' },
