...
/**
 * Rejected application: the editable Back/Next wizard, letting the student
 * correct their sections and re-upload the core application documents.
 */
@Component({
  selector: 'app-rejected-application',
  templateUrl: './RejectedApplication.html',
  styleUrls: ['./edit-application.component.scss'],
})
export class RejectedApplicationComponent implements OnInit, OnDestroy {
